...
//
//    /**
//     * 라벨링 생성 DTO 사용(사진 1 : 라벨 n)
//
//     * @param request RequestBody 정보
//     * @return Response Json 응답
//     */
//    @PostMapping("/api/labeling")
//    public CreateRelationResponse saveRelation(@RequestBody @Valid CreateRelationRequest request) {
